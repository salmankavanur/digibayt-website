...
export const metadata: Metadata = {
  title: "Analytics Dashboard | DigiBayt Admin",
      ...
      <Tabs defaultValue="overview" className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>Last 10 visitors to your website</CardDescription>
              </CardHeader>
              <CardContent>
                <RecentVisits />
              </CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                ...
                <CardDescription>Your most visited pages this month</CardDescription>
              </CardHeader>
              <CardContent>
                <TopPages />
              </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="h-[400px] flex items-center justify-center text-muted-foreground">
                Traffic source chart will be displayed here
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="content" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="h-[400px] flex items-center justify-center text-muted-foreground">
                Content performance metrics will be displayed here
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="conversions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monitor your website's conversion rates</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[400px] flex items-center justify-center text-muted-foreground">
